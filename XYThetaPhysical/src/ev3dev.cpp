...
constexpr char sensor::ht_color[];
...
constexpr char ht_color_sensor::mode_col_color[];
constexpr char ht_color_sensor::mode_col_norm[];
constexpr char ht_color_sensor::mode_col_raw[];
constexpr char ht_color_sensor::mode_col_passive[];
constexpr char ht_color_sensor::mode_col_all[];

ht_color_sensor::ht_color_sensor(address_type address) :
  sensor(address, { "ht-nxt-color-v2" })
{
